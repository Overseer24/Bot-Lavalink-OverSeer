...
declare class AssetsMethods {
     ...
     */
    createGuildEmoji(guildId: string, data: RESTPostAPIGuildEmojiJSONBody & {
        reason?: string;
     ...
     */
    updateGuildEmoji(guildId: string, emojiId: string, data: RESTPatchAPIGuildEmojiJSONBody & {
        reason?: string;
